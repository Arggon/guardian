...
Work in this repo is tracked as Markdown work items under `tasks/`, managed by [`arggon`](https://github.com/Arggon/ArggonManager). Humans and agents follow the same rules. This file is **project-owned**: it describes how guardian applies the arggon convention. (The full v0 spec lives in the ArggonManager repository; this template is the adopter-local summary.)
